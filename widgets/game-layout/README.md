...
## Purpose
Отрисовывает основной интерфейс настольного хоррор-приключения «Whisper of Horror». Компонент собирает каркас игры: верхний заголовок и трёхколоночную основную зону с журналом хода, интерактивной панелью игрока/событий и состоянием мира. Журнал закреплён в первой колонке, а центральный виджет объединяет вступление, руку и фазу событий, поэтому все панели синхронно реагируют на обновления от `GameEngine`.
